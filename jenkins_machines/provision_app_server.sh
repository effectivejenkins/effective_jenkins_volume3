...
mysql -u root -proot -e "GRANT ALL PRIVILEGES ON *.* TO 'springuser'@'%' IDENTIFIED BY 'xXuVBAnXsRm3R2eT' WITH GRANT OPTION; FLUSH PRIVILEGES; SET GLOBAL max_connect_errors=10000;"
